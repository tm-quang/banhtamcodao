        ...
        <div className="h-full flex flex-col">
            ...
            <div className="flex flex-wrap items-end justify-between gap-4 mb-4">
                <div className="flex flex-col">
                    <div className="flex items-center gap-2.5 mb-0.5">
                        <div className="w-9 h-9 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-600 shadow-lg shadow-indigo-100/50">
                            <Ticket size={18} fill="currentColor" />
                        </div>
                        <h1 className="text-2xl font-black text-gray-900 tracking-tight">Mã khuyến mãi</h1>
                    </div>
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.15em] ml-0.5">Quản lý các chương trình Coupon & Voucher ({stats.total} mã)</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        className="flex items-center justify-center gap-2 h-10 !rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-black uppercase text-xs tracking-widest px-8 shadow-xl shadow-indigo-100 transition-all active:scale-95"
                    >
                        Tạo mã mới
                    </Button>
                </div>
                ...
                {loading ? (
                    ...
                    <>
                        <div
                            ...
                            className={`group relative p-5 rounded-[28px] bg-gradient-to-br from-indigo-500 to-blue-700 text-white shadow-2xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 ${statusFilter === 'all' ? 'ring-4 ring-indigo-300 ring-offset-2' : 'shadow-indigo-100'}`}>
                            <div className="absolute -right-4 -bottom-4 opacity-15 group-hover:scale-110 transition-transform duration-700">
                                <Ticket size={110} fill="currentColor" />
                            </div>
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.15em] opacity-80">Tổng số mã</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-6 shadow-sm flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex-1 min-w-[300px]">
                    <div className="relative group">
                        <Input
                            ...
                            startIcon={<Search size={18} className="text-gray-400 group-focus-within:text-indigo-500 transition-colors" />}
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] pr-2">Hiển thị {filteredPromotions.length} kết quả</span>
                </div>
            </div>
            ...
            <div className="flex-1 min-h-[600px]">
                <DataTable
                    ...
                    searchable={false}
                    pageSize={25}
                    emptyStateIcon={<Ticket size={48} className="text-gray-400" />}
